  ...
  return (
    ...
    <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darktheme dark:shadow-white/20 " : ""}`}>
        ...
        <button 
            ...
            className='w-10 h-10 flex items-center justify-center rounded-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 shadow-sm hover:shadow-md transition-all'
        >
        {isDarkMode ? (assets.sun_icon && <Image src={assets.sun_icon} alt="sun" className='w-6'/>) : (assets.moon_icon && <Image src={assets.moon_icon} alt="moon" className='w-6'/>)}
</button>
