...
const Contact = () => {
    ...
    formData.append("access_key", "8b7a1ebe-512d-41a2-90e2-04a611f4f966");
  ...
  return (
    ...
    id="contact" className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo'>
            I'd love to hear from you! Whether you have a question, want to work together, or just want to say hi, feel free to reach out.
        </motion.p>
